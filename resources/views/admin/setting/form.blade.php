                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" method="POST" action="{{route('setting.edit')}}" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="headline">Header Text <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <textarea name="headline" class="form-control" id="headline" rows="3" placeholder="Header Text" required="required">{{ !empty($record->headline)?$record->headline:'' }}</textarea>
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="pinterest">Pinterest <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input id="pinterest" class="form-control" name="pinterest" value="{{ !empty($record->pinterest)?$record->pinterest:'' }}" placeholder="Twitter" required="required" autofocus type="url">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input id="linkedin" class="form-control" name="linkedin" value="{{ !empty($record->linkedin)?$record->linkedin:'' }}" placeholder="Twitter" required="required" autofocus type="url">
                                    </div>
                                </div>
